...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/plain-river-894)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/plain-river-894
```

A live public deployment of this template is available at [https://plain-river-894.templates.workers.dev](https://plain-river-894.templates.workers.dev)
